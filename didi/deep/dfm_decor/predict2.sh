...
tfrecords="/user/prod_recommend/dm_recommend/zhaolei/base/features/merge/tfrecords/TAG=deep_feature_v8_2"
workspace="log"

# ---------------------------- 从hdfs获取上一次的 best model(best模型地址第一次需要先手动创建)
model_path="./log/checkpoint/model_${base}_d${embed_dim}_v0.h5"
